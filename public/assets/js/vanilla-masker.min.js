!(function(a, b) {
	'function' == typeof define && define.amd
		? define(b)
		: 'object' == typeof exports ? (module.exports = b()) : (a.VMasker = b());
})(this, function() {
	...
	(e.prototype.unbindElementToMask = function() {
		for (var a = 0, b = this.elements.length; a < b; a++)
			(this.elements[a].lastOutput = ''),
				...
				this.elements[a].value.length && (this.elements[a].value = this.elements[a].value.replace(/\D/g, ''));
	}),
		(e.prototype.bindElementToMask = function(a) {
			for (
						...
						b(d.keyCode) &&
							setTimeout(function() {
								(c.opts.lastOutput = e.lastOutput),
									...
									e.setSelectionRange &&
										c.opts.suffixUnit &&
										e.setSelectionRange(e.value.length, e.value.length - c.opts.suffixUnit.length);
							}, 0);
					},
					e = 0,
				...
				(this.elements[e].lastOutput = ''),
					...
					this.elements[e].value.length && (this.elements[e].value = f[a](this.elements[e].value, this.opts));
		}),

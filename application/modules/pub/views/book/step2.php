    ...
    <section class="container">
        ...
        <div class="col-sm-12 visible-xs"> 
            <div class="sits-area--mobile">
                ...
                <img alt="" src="<?php echo base_url()?>public/assets/vendor/amovie/images/components/sits_mobile.png">
            </div>
        </div>   
...
<form id='film-and-time' class="booking-form" method='get' action='javascript:'>
    ...
    <div class="booking-pagination booking-pagination--margin">
        <a href="<?php echo base_url()?>pub/home/book" class="booking-pagination__prev">
    ...
    $(document).ready(function() {
            ...
            function ChoosePlace(e) {
                ...
                $('.sits-area--mobile .checked-place').prepend(
                    '<span class="choosen-place" data-sit="' + ch_sits + '">' + ch_sits + '</span>'
                );

    ...
    <div class="col-sm-8 col-md-9">
        ...
        <div class="tags-area">
            <div class="tags tags--unmarked">
                <span class="tags__label">Filter by:</span>
                <ul>
                    <li class="item-wrap">
        ...
        <div class="movie movie--preview release">
            ...
            <div class="col-sm-7 col-md-9">
                ...
                <p class="movie__option">
                    <strong>Release date: </strong>November 1, 2013</p>
                <p class="movie__option">
                ...
                <div class="movie__btns">
                    <a href="#" class="btn btn-md btn--warning">book a ticket
        ...
        <div class="movie movie--preview comments">
            ...
            <div class="col-sm-7 col-md-9">
                ...
                <p class="movie__option">
                    <strong>Release date: </strong>November 8, 2013</p>
                <p class="movie__option">
                    <strong>Director: </strong>
        ...
        <div class="movie movie--preview popularity">
            ...
            <div class="col-sm-7 col-md-9">
                ...
                <p class="movie__option">
                    <strong>Release date: </strong>October 25, 2013</p>
                <p class="movie__option">
                    <strong>Director: </strong>
        ...
        <div class="movie movie--preview popularity">
            ...
            <div class="col-sm-7 col-md-9">
                ...
                <p class="movie__option">
                    <strong>Release date: </strong>September 27, 2013</p>
                <p class="movie__option">
                    <strong>Director: </strong>
                    <a href="#">Alan Taylor</a>
                </p>
        ...
        <div class="movie movie--preview comments">
            ...
            <div class="col-sm-7 col-md-9">
                ...
                <p class="movie__option">
                    <strong>Release date: </strong>September 20, 2013</p>
                <p class="movie__option">
                    <strong>Director: </strong>
                    <a href="#">Alan Taylor</a>
                </p>
    ...
    <aside class="col-sm-4 col-md-3">
        <div class="sitebar">
            ...
            <div class="category category--discuss category--count marginb-sm mobile-category ls-cat">
                <h3 class="category__title">the Most
                    <br>
            ...
            <div class="category category--cooming category--count marginb-sm mobile-category rs-cat">
                <h3 class="category__title">coming soon
                    <br>
